...
void do_query(const SOCKET, const char *);
const char *query_crsnic(const SOCKET, const char *);
const char *query_pir(const SOCKET, const char *);
SOCKET openconn(const char *, const char *);
void usage(void);
