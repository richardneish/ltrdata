...
#define NtCurrentDirectoryHandle() \
  (NtCurrentTeb()->Peb->ProcessParameters->CurrentDirectory.Handle)
...
// UCHAR Data[]; 
  ...
  typedef PETHREAD ERESOURCE_THREAD, *PERESOURCE_THREAD;
  ...
  typedef ERESOURCE_LITE ERESOURCE, *PERESOURCE;
...
// follows after SYSTEM_OBJECTTYPE_INFORMATION.TypeName 
  ...
  } SYSTEM_CRASH_DUMP_STATE_INFORMATION_2000,
    *PSYSTEM_CRASH_DUMP_STATE_INFORMATION_2000;
...
// Time functions 
    ...
    NTSTATUS
    NTAPI
    NtSetSystemTime(IN PLARGE_INTEGER NewTime,
		    OUT PLARGE_INTEGER OldTime OPTIONAL);

    NTSYSAPI
    VOID
    NTAPI
    RtlTimeToTimeFields(IN PLARGE_INTEGER pliTime,
			OUT PTIME_FIELDS pTimeFields);

    NTSYSAPI
    BOOLEAN
    NTAPI
    RtlTimeFieldsToTime(IN PTIME_FIELDS pTimeFields,
...
// Event functions 
    ...
    NtOpenEvent(PHANDLE phEvent,
		ACCESS_MASK AccessMask, POBJECT_ATTRIBUTES pObjectAttributes);

    NTSYSAPI NTSTATUS NTAPI NtClearEvent(IN HANDLE hEvent);

    NTSYSAPI
    NTSTATUS
    NTAPI NtSetEvent(IN HANDLE hEvent, OUT PLONG plSignaled OPTIONAL);
...
// Directory and Symbolic Link functions 
    ...
    NTSTATUS
    NTAPI
    NtCreateDirectoryObject(OUT PHANDLE phDirectory,
...
// File functions 
    ...
    NtCreateFile(PHANDLE phFile,
		 ...
		 ULONG uCreateOptions, PVOID pEaBuffer, ULONG uEaLength);
    ...
    NtOpenFile(PHANDLE phFile,
	       ...
	       POBJECT_ATTRIBUTES pObjectAttributes,
	       PIO_STATUS_BLOCK pIoStatusBlock,
	       ULONG uShareAccess, ULONG uOpenOptions);

    NTSYSAPI
    NTSTATUS NTAPI NtDeleteFile(IN POBJECT_ATTRIBUTES pObjectAttributes);
...
#define NtCurrentProcess() ((HANDLE) -1)
    ...
    NTSTATUS
    NTAPI
    NtOpenProcess(OUT PHANDLE phProcess,
		  IN ACCESS_MASK AccessMask,
		  IN POBJECT_ATTRIBUTES pObjectAttributes,
...
#define LDT_TABLE_SIZE (8 * 1024 * sizeof(LDT_ENTRY))
  ...
  typedef struct _PROCESS_DEFAULT_HARDERROR_MODE_INFORMATION
  {
    ...
    *PPROCESS_DEFAULT_HARDERROR_MODE_INFORMATION;
  ...
  typedef struct _PROCESS_POOLED_USAGE_AND_LIMITS_INFORMATION
  {
    ...
    ULONG PagefileUsage;
    ULONG PagefileLimit;
  } PROCESS_POOLED_USAGE_AND_LIMITS_INFORMATION,
    *PPROCESS_POOLED_USAGE_AND_LIMITS_INFORMATION;
...
#define KRNL_REALTIME_PRIORITY_CLASS 0x04
  ...
  typedef struct _PROCESS_SESSION_INFORMATION
  {
    ...
    NTSTATUS
    NTAPI
    NtQueryInformationProcess(IN HANDLE hProcess,
    ...
    NTSTATUS
    NTAPI
    NtSetInformationProcess(IN HANDLE hProcess,
			    IN PROCESSINFOCLASS ProcessInformationClass,
			    OUT PVOID pProcessInformation,
			    IN ULONG uProcessInformationLength);
    ...
    NTSTATUS
    NTAPI
    RtlCreateProcessParameters(OUT PPROCESS_PARAMETERS * ProcessParameters,
    ...
    NTSTATUS
    NTAPI
    RtlDestroyProcessParameters(IN PPROCESS_PARAMETERS ProcessParameters);
...
#define NtCurrentThread() ((HANDLE) -2)
  ...
  typedef struct _USER_STACK
  {
    ...
    NTSTATUS
    NTAPI
    NtOpenThread(OUT PHANDLE phThread,
		 IN ACCESS_MASK AccessMask,
		 IN POBJECT_ATTRIBUTES pObjectAttributes,
		 IN PCLIENT_ID pClientId);
  ...
  } THREAD_DESCRIPTOR_TABLE_ENTRY_INFORMATION,
  ...
  typedef struct _THREAD_WIN32_START_ADDRESS_INFORMATION
  {
    ...
    *PTHREAD_WIN32_START_ADDRESS_INFORMATION;
  ...
  typedef struct _THREAD_PERFORMANCE_COUNTER_INFORMATION
  {
    ...
    *PTHREAD_PERFORMANCE_COUNTER_INFORMATION;
  ...
  typedef struct _THREAD_HIDE_FROM_DEBUGGER
  {
    ...
    NTSTATUS
    NTAPI
    NtQueryInformationThread(IN HANDLE hThread,
    ...
    NTSTATUS
    NTAPI
    NtSetInformationThread(IN HANDLE hThread,
			   IN THREADINFOCLASS ThreadInformationClass,
			   OUT PVOID pThreadInformation,
			   IN ULONG uthreadInformationLength);
    ...
    NTSTATUS
    NTAPI
    NtOpenThreadToken(IN HANDLE hThread,
		      IN ACCESS_MASK DesiredAccess,
		      IN BOOLEAN bOpenAsSelf, OUT PHANDLE phToken);
    ...
    NTSYSAPI
    NTSTATUS
    NTAPI NtGetContextThread(IN HANDLE ThreadHandle, OUT PCONTEXT Context);

    NTSYSAPI
    NTSTATUS
    NTAPI NtSetContextThread(IN HANDLE ThreadHandle, IN PCONTEXT Context);
    ...
    NTSYSAPI NTSTATUS NTAPI NtImpersonateAnonymousToken(IN HANDLE hThread);

    NTSYSAPI NTSTATUS NTAPI NtMakeTemporaryObject(IN HANDLE Handle);
  ...
  typedef struct _SECTION_IMAGE_INFORMATION
  {
    ...
    NTSYSAPI NTSTATUS NTAPI NtWaitForSingleObject(IN HANDLE hObject, IN BOOL fAlertable, IN PLARGE_INTEGER pliTimeout	// NULL = infinite 
    );
...
// Object functions 
  ...
  typedef struct _OBJECT_HANDLE_ATTRIBUTE_INFORMATION
  {
    ...
    *POBJECT_HANDLE_ATTRIBUTE_INFORMATION;
    ...
    NTSTATUS
    NTAPI
    NtQuerySecurityObject(IN HANDLE FileHandle,
    ...
    NTSTATUS
    NTAPI
    NtSetSecurityObject(IN HANDLE FileHandle,
			IN SECURITY_INFORMATION SecurityInformation,
...
// Ldr Functions 
    NTSYSAPI NTSTATUS NTAPI LdrDisableThreadCalloutsForDll(IN HANDLE hModule);
...
// Rtl String Functions 
    ...
    VOID
    NTAPI
    RtlInitUnicodeString(OUT PUNICODE_STRING DestinationString,
			 IN PCWSTR SourceString);

    NTSYSAPI
    BOOLEAN
    NTAPI
    RtlCreateUnicodeString(OUT PUNICODE_STRING AllocatedString,
			   IN PCWSTR SourceString);

    NTSYSAPI
    VOID
    NTAPI RtlFreeUnicodeString(IN PUNICODE_STRING UnicodeString);
    ...
    NTSTATUS
    NTAPI
    RtlAnsiStringToUnicodeString(OUT PUNICODE_STRING DestinationString,
    ...
    NTSTATUS
    NTAPI
    RtlAppendUnicodeStringToString(OUT PUNICODE_STRING Destination,
				   IN PUNICODE_STRING Source);

    NTSYSAPI
    NTSTATUS
    NTAPI
    RtlAppendUnicodeToString(OUT PUNICODE_STRING Destination,
			     IN PWSTR Source);
    ...
    VOID
    NTAPI
    RtlCopyUnicodeString(OUT PUNICODE_STRING DestinationString,
			 IN PUNICODE_STRING SourceString);

    NTSYSAPI
    NTSTATUS
    NTAPI
    RtlDowncaseUnicodeString(OUT PUNICODE_STRING DestinationString,
			     IN PUNICODE_STRING SourceString,
			     IN BOOLEAN AllocateDestinationString);
    ...
    RtlIntegerToUnicodeString(IN ULONG Value,
			      IN ULONG Base, OUT PUNICODE_STRING String);

    NTSYSAPI
    NTSTATUS
    NTAPI
    RtlUnicodeStringToInteger(IN PUNICODE_STRING String,
			      IN ULONG Base, OUT PULONG Value);
    ...
    NTSTATUS
    NTAPI
    RtlOemStringToUnicodeString(OUT PUNICODE_STRING DestinationString,
    ...
    NTSYSAPI WCHAR NTAPI RtlUpcaseUnicodeChar(IN WCHAR SourceCharacter);

    NTSYSAPI
    NTSTATUS
    NTAPI
    RtlUpcaseUnicodeString(OUT PUNICODE_STRING DestinationString,
			   IN PUNICODE_STRING SourceString,
			   IN BOOLEAN AllocateDestinationString);

    NTSYSAPI
    ULONG NTAPI RtlxAnsiStringToUnicodeSize(IN PANSI_STRING AnsiString);

    NTSYSAPI ULONG NTAPI RtlxOemStringToUnicodeSize(IN POEM_STRING OemString);

    NTSYSAPI
    NTSTATUS
    NTAPI
    RtlUnicodeStringToOemString(POEM_STRING DestinationString,
...
// Rtl Misc Operations 
    NTSYSAPI NTSTATUS NTAPI NtReplyPort(IN HANDLE hPort, OUT PVOID pReply);

    NTSYSAPI NTSTATUS NTAPI NtClose(IN HANDLE hObject);

    NTSYSAPI ULONG NTAPI RtlNtStatusToDosError(NTSTATUS status);

    NTSYSAPI UINT NTAPI RtlGetLongestNtPathLength();
...
#define Li2Double(x) ((double)((x).HighPart) * 4.294967296E9 + (double)((x).LowPart))
    ...
    LARGE_INTEGER
    NTAPI
    RtlEnlargedIntegerMultiply(IN LONG lMultiplicand, IN LONG lMultiplier);

    NTSYSAPI
    ULONG
    NTAPI
    RtlEnlargedUnsignedDivide(IN LARGE_INTEGER liDividend,
			      IN ULONG uDivisor,
    ...
    LARGE_INTEGER
    NTAPI
    RtlEnlargedUnsignedMultiply(IN ULONG uMultiplicand, IN ULONG uMultiplier);

    NTSYSAPI
    LARGE_INTEGER
    NTAPI
    RtlExtendedIntegerMultiply(IN LARGE_INTEGER liMultiplicand,
			       IN LONG lMultiplier);

    NTSYSAPI
    LARGE_INTEGER
    NTAPI
    RtlExtendedLargeIntegerDivide(IN LARGE_INTEGER liDividend,
				  IN ULONG uDivisor,
				  OUT PULONG puRemainder OPTIONAL);
    ...
    LARGE_INTEGER
    NTAPI
    RtlLargeIntegerAdd(IN LARGE_INTEGER liAddend1,
		       IN LARGE_INTEGER liAddend2);

    NTSYSAPI
    LARGE_INTEGER
    NTAPI
    RtlLargeIntegerDivide(IN LARGE_INTEGER liDividend,
			  IN LARGE_INTEGER liDivisor,
			  OUT PLARGE_INTEGER pliRemainder OPTIONAL);

    NTSYSAPI
    LARGE_INTEGER NTAPI RtlLargeIntegerNegate(IN LARGE_INTEGER liSubtrahend);

    NTSYSAPI
    LARGE_INTEGER
    NTAPI
    RtlLargeIntegerSubtract(IN LARGE_INTEGER liMinuend,
...
#define PDI_LOCKS 0x20
  ...
  typedef struct _DEBUG_LOCK_INFORMATION	// c.f. SYSTEM_LOCK_INFORMATION 
  {
    ...
    NTSYSAPI
    PDEBUG_BUFFER
    NTAPI RtlCreateQueryDebugBuffer(IN ULONG Size, IN BOOLEAN EventPair);
    ...
    NTSYSAPI
    NTSTATUS NTAPI RtlDestroyQueryDebugBuffer(IN PDEBUG_BUFFER DebugBuffer);
...
// "\Registry\Machine\System\CurrentControlSet\Services\<DriverName>" 
    ...
    RtlAdjustPrivilege(IN ULONG Privilege,
		       IN BOOLEAN NewValue,
		       IN BOOLEAN ForThread, OUT PBOOLEAN OldValue);
    ...
    NTSYSAPI ULONG CDECL DbgPrint(IN PCHAR Format, ...);

    NTSYSAPI
    ULONG
    NTAPI
    DbgPrintEx(IN ULONG ComponentId, IN ULONG Level, IN PCHAR Format, ...);
