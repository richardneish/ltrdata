...
public class Main
{
  public static void main(String[] arg)
  {
    ...
    // Skapa projektresursobjekt för varje anställd som ska arbeta i projektet
    ...
    // Lägg till projektresursobjekten i projektobjektet
    ...
    // Lägg till faktiska tider i projektresursobjekten
