...
public class Project
{
  ...
  private Vector Resources; //Innehåller projektets resurser
  ...
  public void evaluate()
  {
    ...
    System.out.println("Totalt antal budgeterade timmar: " + sumBudgetHours +
      " (" + sumBudgetCost + " kr), utförda timmar: " + sumActualHours +
      " (" + sumActualCost + " kr).");
  }
}
